...
<body id="target">
	<div class="container">
		<header class="jumbotron text-center">
			<img src="https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcRtahc9eHeCeD0G4r0gLpYLboFN9cce7YG1M-aN1iIra-KmS0H8-9va5Fap"
			alt="생활코딩" class="img-circle" id="logo"/>
				...
				<article>
					<form action="process.php" method="post">
					    ...
					    <label for="form-author">본문</label>
							<textarea class="form-control" rows="10" name="description" id="description" placeholder="본문을 적어주세요"></textarea>
						</div>
